...
const translations = {
  en: {
    ...
    'oil_type': 'Oil Type',
    'mineral': 'Mineral Oil',
    'semi_synthetic': 'Semi-Synthetic Oil',
    'full_synthetic': 'Full-Synthetic Oil',
    'recommended_interval': 'Recommended Interval',
    'oil_recommendation_info': 'Recommendation guidelines based on vehicle and oil type',
    'time_recommendation_motorcycle': 'Oil change is recommended every 2-3 months.',
    'time_recommendation_car': 'Oil change is recommended every 6 months.',
    'overdue_by_time': 'Overdue by time ({months} months passed)',
    'time_left_display': '{months} months left',
    'trackers': 'Trackers',
  ...
  id: {
    ...
    'oil_type': 'Jenis Oli',
    'mineral': 'Oli Mineral',
    'semi_synthetic': 'Oli Semi-Sintetis',
    'full_synthetic': 'Oli Full-Sintetis',
    'recommended_interval': 'Interval yang Direkomendasikan',
    'oil_recommendation_info': 'Panduan rekomendasi berdasarkan tipe kendaraan & jenis oli',
    'time_recommendation_motorcycle': 'Ganti oli direkomendasikan setiap 2-3 bulan.',
    'time_recommendation_car': 'Ganti oli direkomendasikan setiap 6 bulan.',
    'overdue_by_time': 'Sebab waktu ({months} bulan)',
    'time_left_display': 'Sisa {months} bulan',
    'trackers': 'Pelacak',
